            ...
            <div className="right_dashboard">
                ...
                <div className="info">
                        <div className="profile-container">
                            ...
                            <p>Skill: HTML5, CSS, JavaScript, React, JSON, Ajax, NodeJS, PHP, C++, Java, Python</p>
                        </div>
                ...
                <div className="">
                    <li className="buttons"><button className="save-button">save</button></li>
                    <li className="buttons"><button className="cancel-button">cancel</button></li>
                </div>
